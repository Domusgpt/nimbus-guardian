...
9. **Operator playbook** – Add a three-step rollout row that links to the plugin manifest, CLI checklist, and dashboard configuration guide so teams can execute the plan without digging through long-form docs.
