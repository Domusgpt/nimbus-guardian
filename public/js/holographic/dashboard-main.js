...
function createCopyCommandButton(command, toolLabel) {
    const button = document.createElement('button');
    button.type = 'button';
    button.className = 'holo-button compact ghost';
    ...
    button.addEventListener('click', async event => {
        ...
        try {
            ...
            showToast(`Copied install command for ${toolLabel}.`, 'success');
        } catch (error) {
            console.error('Failed to copy install command', error);
            showToast('Unable to copy command. Copy it manually from the details.', 'error');
        } finally {
        ...
        if (missing.length) {
            ...
            missing.forEach(tool => {
                ...
                if (installCommand) {
                    ...
                    primaryAction.className = 'holo-button compact';
                    primaryAction.textContent = 'Install';
                    primaryAction.dataset.command = installCommand;
                    primaryAction.dataset.tool = toolLabel;
                    primaryAction.addEventListener('click', assistantHandlers.handleInstallTool);
                } else if (docsLink) {
                    primaryAction = document.createElement('a');
                    primaryAction.className = 'holo-button compact';
                    primaryAction.textContent = 'Docs';
                    primaryAction.href = docsLink;
                    ...
                    primaryAction.type = 'button';
                    primaryAction.className = 'holo-button compact';
                    primaryAction.textContent = 'Manual';
                    primaryAction.disabled = true;
                    primaryAction.title = 'Review details below to install manually.';
                }
                ...
                if (installCommand) {
                    actions.appendChild(createCopyCommandButton(installCommand, toolLabel));
                }
