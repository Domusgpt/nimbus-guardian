...
import { createAssistantActions } from './assistant.js';
...
function createIssueItem(issue, type = 'issue') {
    ...
    if (issue.autoFixable && issue.id) {
        ...
        button.addEventListener('click', assistantActions.handleAutoFix);
        ...
        if (missing.length) {
            ...
            missing.forEach(tool => {
                ...
                if (installCommand) {
                    ...
                    action.addEventListener('click', assistantActions.handleInstallTool);
                } else if (docsLink) {
