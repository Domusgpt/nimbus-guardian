...
function initMouseParallax() {
    ...
    function animate() {
        ...
        const cards = document.querySelectorAll('.feature-card, .pricing-card, .observability-card, .playbook-card, .constellation-card, .trajectory-card, .terminal-card, .terminal-note, .resource-tile, .faq-item');
...
function initScrollAnimations() {
    ...
    // Observe all cards
    const cards = document.querySelectorAll('.feature-card, .step, .catch-card, .pricing-card, .observability-card, .playbook-card, .constellation-card, .trajectory-card, .terminal-card, .terminal-note, .resource-tile, .faq-item');
    cards.forEach((card, index) => {
