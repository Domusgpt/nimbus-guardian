...
function initMouseParallax() {
    ...
    function animate() {
        ...
        const cards = document.querySelectorAll('.feature-card, .pricing-card, .observability-card, .observability-panel');
...
function initScrollAnimations() {
    ...
    // Observe all cards
    const cards = document.querySelectorAll('.feature-card, .step, .catch-card, .pricing-card, .observability-card, .observability-panel');
    cards.forEach((card, index) => {
