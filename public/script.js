...
function initMouseParallax() {
    ...
    function animate() {
        ...
        const cards = document.querySelectorAll('.feature-card, .pricing-card, .observability-card, .constellation-card, .trajectory-card, .terminal-card, .terminal-note, .resource-tile, .faq-item, .playbook-step');
...
function initScrollAnimations() {
    ...
    // Observe all cards
    const cards = document.querySelectorAll('.feature-card, .step, .catch-card, .pricing-card, .observability-card, .constellation-card, .trajectory-card, .terminal-card, .terminal-note, .resource-tile, .faq-item, .playbook-step');
    cards.forEach((card, index) => {
